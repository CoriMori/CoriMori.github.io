...
const ProjectData = [
    ...
    },
    {
        ...
        video: "https://youtu.be/wCUVp5mp43o?si=W4tWF50VLB0GmJzw",
        projectLink: "https://cori-mori.itch.io/dungeon-raiders",
        githubLink: "https://github.com/CoriMori/DungeonRaider",
        tags: [PROJECT_TAGS.PERSONAL, PROJECT_TAGS.UE],
    },
    {
        projectName: "Parkour Ball",
        images: ["project_images/ParkourBall/PB_1.png", "project_images/ParkourBall/PB_2.png", "project_images/ParkourBall/PB_3.png"],
        engine: ENGINES.UE,
        role: ROLE.LDD,
        summary: "A short puzzle platformer with dodgeballs!",
        status: TAGS.COMPLETED,
        projectType: TAGS.PERSONAL,
        language: LANGUAGES.CB,
        modalBody: "Parkour Ball is a short demo project that I made to continue getting comfortable with C++ in Unreal Engine 5. This project is very small, featuring only two platform types that can either move automatically or be triggered via a linked button. Platforms location, rotation, or both can be altered using various settings found on a custom Movement Component. The Platform Buttons can be triggered using a Throwable Projectile. The main goal of this project was to reinforce what I learned in Dungeon Raiders, and play around with spawning fun projectiles. I may take the throwing mechanic of this and use it in a future project because it is really fun to throw the dodgeballs around. This project took me about three days to complete and overall I’m pretty happy with the result for a rapid prototype.",
        video: "https://www.youtube.com/watch?v=CbRCHRQP0Xg",
        projectLink: "https://cori-mori.itch.io/parkour-ball",
        githubLink: "https://github.com/CoriMori/ParkourBallDemo",
        tags: [PROJECT_TAGS.PERSONAL, PROJECT_TAGS.UE],
    },
    {
        projectName: "Movement Demo",
        images: ["project_images/MovementDemo/MvmtDemo_Splash.png", "project_images/MovementDemo/MvmtDemo_1.png", "project_images/MovementDemo/MvmtDemo_2.png", "project_images/MovementDemo/MvmtDemo_3.png", "project_images/MovementDemo/MvmtDemo_4.png", "project_images/MovementDemo/MvmtDemo_5.png"],
        engine: ENGINES.UE,
        role: ROLE.LDD,
        summary: "Powered by GAS and Motion Warping!",
        status: TAGS.COMPLETED,
        projectType: TAGS.PERSONAL,
        language: LANGUAGES.CB,
        modalBody: "Movement Demo is an advanced movement demo powered by the Gameplay Ability System and Motion Warping plugins. I wanted to explore some more advanced movement mechanics, like vaulting, dodging, and climbing. Vaulting, dodging, and climbing are all Gameplay Abilities that can be assigned to any character. Vaulting and dodging also support multiplayer gameplay, however climbing currently does not. During the course of this project, I had to make a couple ability tasks and even create a custom movement component to handle custom movement modes. This was my first time working with Motion Warping and custom movement modes, and it was a really fun experience. Overall I think this project turned out really great. There are a few issues with vaulting and jumping using the same controls, but a little tweaking can have that fixed in no time. I have labeled this as version 1.0, but also marked it complete because while I plan to expand on what I have built, the next iteration of this demo will be made with Motion Mapping. So in my brain, they’re different enough to warrant a different project entirely. So keep an eye out for version 2.0 in the near future!",
        video: "https://youtu.be/hgsGB2ifu20?si=O9pA1jHm-irfJRg0",
        projectLink: "https://cori-mori.itch.io/movement-demo",
        githubLink: "https://github.com/CoriMori/MovementDemo",
        tags: [PROJECT_TAGS.PERSONAL, PROJECT_TAGS.UE],
    },
    {
        ...
        video: "https://youtu.be/7YpDlTW4zT4?si=-y0FMV5WTrTbKapC",
        projectLink: "",
        githubLink: "",
    ...
    },
    {
        ...
        video: "https://youtu.be/lyAMMw5ScwY?si=ajUAUxpKzJYq7SBV",
        projectLink: "",
        githubLink: "",
        tags: [PROJECT_TAGS.PROFESSIONAL, PROJECT_TAGS.PHASER],
    },
    {
        ...
        video: "https://youtu.be/p68r2xIcXTM?si=hyboqXizCZY2KWPP",
        projectLink: "",
        githubLink: "",
        tags: [PROJECT_TAGS.PROFESSIONAL, PROJECT_TAGS.PHASER],
    },
    {
        ...
        video: "https://youtu.be/Q2hIlalRvLo?si=2w7B3fgkdipDTzuh",
        projectLink: "",
        githubLink: "",
        tags: [PROJECT_TAGS.PROFESSIONAL, PROJECT_TAGS.PHASER],
    },
    {
        ...
        video: "https://youtu.be/jUdGO43sF5k?si=I3AGt4O-IpSeApfj",
        projectLink: "",
        githubLink: "",
        tags: [PROJECT_TAGS.PROFESSIONAL, PROJECT_TAGS.PHASER],
    },
